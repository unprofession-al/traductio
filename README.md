...
`traductio` reads JSON data from a configurable source, extraxts relevant the information using `jq` like syntax and stores
...
data from [ElasticSearch](https://www.elastic.co/elasticsearch/) and storing aggregates as performant and
